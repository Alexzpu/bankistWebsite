...
// logic for highlight and blur the nav bar
...
// shows nav bar after scrollinf one section
...
headerObserver.observe(headerselect);


// adding animation on section with observer
...
allSectionsObserver.forEach(function(section) {
...
document.addEventListener('DOMContentLoaded', function(e) {
  console.log('HTML parset and DOM tree built!', e);
});
